...
export const files = {
  ...
  ".github/workflows/validate.yml": [
    ...
    const commandStart = lines.indexOf("node -c scripts/component-state-workflow-contract.mjs");
    const commandEnd = lines.indexOf("consumer-reference/policies/shared-experimental.json");
